      ...
      <Layout>
        <div className="w-full max-w-3xl text-center">
          ...
          <ul className="text-left text-zinc-700 dark:text-zinc-300 space-y-4 text-sm">
            <li>
              ✅ Version 3 – TV Show support, multi-entry, polished embeds
            </li>
            <li>
              🚧 Version 4 – Fuzzy matching, slash command builder, external
              data sync
            </li>
            <li>
              🔮 Future – GUI frontend (suvie.me), public stats, and premium
              tier
            </li>
          </ul>
        </div>
