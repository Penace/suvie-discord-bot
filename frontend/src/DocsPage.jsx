        ...
        <div className="w-full max-w-4xl">
          ...
          <section className="mb-10">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              Talk to suvie like a friend. Ask for recommendations, keep track
              of your mood, and explore new films with conversational AI. Use{" "}
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-zinc-700 dark:text-zinc-300 space-y-1">
              ...
              <li>
                Everything is saved automatically — no need to worry about
                losing data
              </li>
            </ul>
          </section>
